...
import {
  colorToCss,
  connectionIDtoColors,
  findIntersectingLayersWithRectangle,
  penPointToPathLayers,
...
import { useDeleteLayers } from "@/app/hooks/use-delete-layer";
...
export const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const insertPath = useMutation(
    ({ storage, self, setMyPresence }) => {
      ...
      liveLayers.set(
        id,
        new LiveObject(penPointToPathLayers(pencilDraft, lastUsedColor))
      );
